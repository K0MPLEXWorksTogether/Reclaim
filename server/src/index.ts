...
import habitEntryRoutes from "./routers/habitEntry.route";
...
import HabitEntrySwaggerRoute from "./swagger/habitEntry.swagger";
...
app.use("/habit-entry", habitEntryRoutes);
...
app.use("/api-docs/habit-entry", HabitEntrySwaggerRoute);
